...
switch(option)
    ...
    case('MDFC')
                ...
                for iPointx = 1 : length(ENVIRONMENT.x(1,:))
                    ...
                    utility = (1-o.ComputeProbDetect(o.act(1,i1,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(1,i1,:),o.act(1,i1,:)))*...
                        (1-o.ComputeProbDetect(o.act(1,i1,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(1,i1,:),o.act(2,i2,:)))*...
                        (1-o.ComputeProbDetect(o.act(1,i1,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(1,i1,:),o.act(3,i3,:)))*...
                        (1-o.ComputeProbDetect(o.act(1,i1,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(1,i1,:),o.act(4,i4,:)))*...
                        (1-o.ComputeProbDetect(o.act(2,i2,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(2,i2,:),o.act(1,i1,:)))*...
                        (1-o.ComputeProbDetect(o.act(2,i2,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(2,i2,:),o.act(2,i2,:)))*...
                        (1-o.ComputeProbDetect(o.act(2,i2,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(2,i2,:),o.act(3,i3,:)))*...
                        (1-o.ComputeProbDetect(o.act(2,i2,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(2,i2,:),o.act(4,i4,:)))*...
                        (1-o.ComputeProbDetect(o.act(3,i3,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(3,i3,:),o.act(1,i1,:)))*...
                        (1-o.ComputeProbDetect(o.act(3,i3,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(3,i3,:),o.act(2,i2,:)))*...
                        (1-o.ComputeProbDetect(o.act(3,i3,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(3,i3,:),o.act(3,i3,:)))*...
                        (1-o.ComputeProbDetect(o.act(3,i3,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(3,i3,:),o.act(4,i4,:)))*...
                        (1-o.ComputeProbDetect(o.act(4,i4,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(4,i4,:),o.act(1,i1,:)))*...
                        (1-o.ComputeProbDetect(o.act(4,i4,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(4,i4,:),o.act(2,i2,:)))*...
                        (1-o.ComputeProbDetect(o.act(4,i4,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(4,i4,:),o.act(3,i3,:)))*...
                        (1-o.ComputeProbDetect(o.act(4,i4,:),[ENVIRONMENT.x(iPointx,iPointy);ENVIRONMENT.y(iPointx,iPointy)])*...
                        o.ComputeProbComm(o.act(4,i4,:),o.act(4,i4,:)));
