    ...
    case 4 % 2D case
        ...
        switch property
            case 'Pos'
                ...
                target.id = ID;
                 target.x = ...
                     [100*cos(target.id*2*pi/(nTarget+1))-400,100*sin(target.id*2*pi/(nTarget+1))]'; % x_pos, y_pos
%                  target.x = ...
...
%                      field.bufferZone(3)+rand()*field.zoneLength(2)]'; % x_pos, y_pos
            ...
            case 'PosRF'
                ...
                target.id = ID;
                target.x = ...
                    [100*cos(target.id*2*pi/(nTarget+1))-400,100*sin(target.id*2*pi/(nTarget+1)),1.81e-6, 1.2]'; % x_pos, y_pos, k0, alpha
%                                  target.x = ...
%                                      [field.bufferZone(1)+rand()*field.zoneLength(1)...
