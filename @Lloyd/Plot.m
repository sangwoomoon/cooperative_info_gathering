...
for iAgent = 1 : length(o.C(1,:))
    switch (option)
        case 'point'
            plot(o.C(1,iAgent),o.C(2,iAgent),o.plot.marker(1,:),'color',o.plot.statecolor,'MarkerSize',o.plot.markersize,'LineWidth',o.plot.linewidth); hold on;
        case 'profile'
