function h = PlotGaussianEllipsoid(m, C, sdwidth, npts, axh)
...
%  figure;
%  h1 = PlotGaussianEllipsoid([1 1], [1 0.5; 0.5 1]);
%  h2 = PlotGaussianEllipsoid([2 1.5], [1 -0.7; -0.7 1]);
%  h3 = PlotGaussianEllipsoid([0 0], [1 0; 0 1]);
%  set(h2,'color','r');
%  set(h3,'color','g');
%
...
%  figure;
%  for sd = [0.3:0.4:4],
%    h = PlotGaussianEllipsoid([0 0], [1 0.8; 0.8 1], sd);
%  end
%
%  % Plot three 3-d Gaussians
%  figure;
%  h1 = PlotGaussianEllipsoid([1 1  0], [1 0.5 0.2; 0.5 1 0.4; 0.2 0.4 1]);
%  h2 = PlotGaussianEllipsoid([1.5 1 .5], [1 -0.7 0.6; -0.7 1 0; 0.6 0 1]);
%  h3 = PlotGaussianEllipsoid([1 2 2], [0.5 0 0; 0 0.5 0; 0 0 0.5]);
